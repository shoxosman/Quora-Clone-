...
function Sidebar() {
  ...
  return (
    <div className=' flex  fixed hover:overflow-auto overflow-hidden h-3/4 overflow-x-hidden flex-col md:ml-20 lg:ml-40'>
        <button className=' h-9 sm:w-10 md:w-32 lg:w-52 bg-xlightgray my-3 flex rounded-sm  hover:bg-midgray slef-center'><p className='self-center'>+ Create Space</p></button>
